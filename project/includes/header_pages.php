<header class="navbar">
    <div class="navbar-container">
        ...
        <div class="navbar-actions">
            <div class="nav-item <?php echo ($current_page == 'login') ? 'active' : ''; ?>" onclick="navigateTo('login.php')" title="Entrar">
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-nav-items">
            ...
            <a href="vendedor.php">Seja um Vendedor</a>
    ...
    <nav class="main-nav">
        <div class="container">
            <ul class="nav-links">
                <li><a href="../index.php" <?php echo ($current_page == 'home') ? 'class="active"' : ''; ?>>Início</a></li>
                <li><a href="produtos.php" <?php echo ($current_page == 'produtos') ? 'class="active"' : ''; ?>>Produtos</a></li>
                <li><a href="lojas.php" <?php echo ($current_page == 'lojas') ? 'class="active"' : ''; ?>>Lojas</a></li>
                <li><a href="sobre.php" <?php echo ($current_page == 'sobre') ? 'class="active"' : ''; ?>>Sobre Nós</a></li>
                <li><a href="vendedor.php" <?php echo ($current_page == 'vendedor') ? 'class="active"' : ''; ?>>Seja um Vendedor</a></li>
            </ul>
        </div>
    </nav>
</header>
