...
<div class="banner-layout">
  ...
  <section class="banner-principal">
    <div class="banner-conteudo">
      <h1>Transforme o Mundo com Cada Compra</h1>
      <p>Descubra produtos sustentáveis que fazem a diferença para o planeta</p>
      <button class="btn-cta">Explorar Produtos</button>
    </div>
