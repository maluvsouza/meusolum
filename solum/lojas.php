...
<div class="containerLojas">
  ...
  <div class="store-card" data-store-id="<?= $loja['lojID'] ?>">
    ...
    <div class="store-info">
      ...
      <!-- Se não tiver avaliação no banco, talvez retire essa parte ou implemente -->
      <div class="store-rating">
        <div class="stars">
          <?= generateStars(0) // exemplo fixo, adapte conforme avaliação real ?>
        </div>
        <span class="rating-text">0.0/5</span>
      </div>

      <div class="store-stats">
        <i class="fas fa-box"></i> <!-- total_produtos: precisa criar consulta -->
        0 produtos
      </div>
