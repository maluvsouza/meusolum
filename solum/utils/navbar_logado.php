    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      ...
      <div class="offcanvas-body cinza ">
        ...
        <div class="nav-offcanvas-texto">
          ...
          <br>
          <a href="cadastrar-pagamento" class="nav-off-botoes"> <i class="bi bi-credit-card-2-front-fill azul"></i>
            Cadastrar métodos de pagamento </a>
          <br>
          <a href="encerrar-sessao.php" class="nav-off-botoes"> <i class="bi bi-box-arrow-left azul"></i> Sair da
            conta
          </a>
          <hr>
        </div>
