    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      ...
      <div class="offcanvas-body cinza ">
        <div class="nav-offcanvas-texto">
          ...
          <br>
          <a href="cadastrar-pagamento"> <i class="bi bi-credit-card-2-front-fill azul"></i> Cadastrar métodos de
            pagamento </a>
          <br>
...
<div class="navcategoria">
  ...
  <div class="navlinkcategoria">
    <strong>Como vender</strong>
  </div>

  <div class="navlinkcategoria">
    <a href=""></a> <strong>Sobre Nós</strong>
  </div>
