...
<div class="container-display-produto">
  <div class="container-display-fotos-produto"> <img class="produto-foto-destaque" src="https://picsum.photos/300"
      id="imagemPrincipal"> </img>
  ...
  <div class="container-display-infos-produto">
    ...
    <form action="add-carrinho.php" method="post" class="">
      <button type="submit" class="btn btn-primary" value="AddCarrinho" id="addCarrinho">Adicionar ao carrinho <i
