...
<strong style="color: var(--primary-orange);"> meio ambiente</strong><br> a prosperar. <br>
...
if ($numLatest > 0) {
    while ($row = $stmtLatest->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<p>Vendido por <a href='perfil-loja.php?lojID={$proLojaID}' style='text-decoration: none; color: var(--primary-orange);'> {$lojNome} </a></p>";
        echo "</div>";
        echo "</div>";
        echo "</a>";
    }
